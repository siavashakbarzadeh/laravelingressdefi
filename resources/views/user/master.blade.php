...
<script src="{{ asset('assets/admin/dist/js/metamask/web3.min.js') }}"></script>
<script src="{{ asset('assets/admin/dist/js/metamask/metamask.min.js') }}"></script>
