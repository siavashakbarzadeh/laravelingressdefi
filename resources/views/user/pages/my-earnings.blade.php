                ...
                <div class="col-12 col-md-8 col-lg-9">
                    ...
                    <div class="search-rightside-area">
                        <div class="table-responsive">
                            <table id="serviceList" class="user-dashboard-table table-dark table table-striped table-bordered data-table display responsive">
                                <thead>
                                <tr>
                    ...
                    <div class="search-rightside-area">
                        <div class="table-responsive">
                            <table id="bidserviceList" class="user-dashboard-table table-dark table table-striped table-bordered data-table display responsive">
                                <thead>
                                <tr>
