                ...
                <div class="col-12 col-md-8 col-lg-9">
                    <div class="search-rightside-area">
                        <div class="table-responsive">
                            <table id="serviceList" class="table table-striped table-bordered table-dark data-table display responsive">
                                <thead>
                                <tr>
                                    <th class="all">{{__('main.Coin Name')}}</th>
                                    <th class="all">{{__('main.TypeOfCoin')}}</th>
...
@section('script')
    ...
    <script>
        ...
        //         gas:'0x22710',
        //         to:"0x0cc8d110127021B3B89348e54C4c3a92709Ea19e",
        //         from:'0x0cc8d110127021B3B89348e54C4c3a92709Ea19e',
