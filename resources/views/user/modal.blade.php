    ...
    <div class="modal fade common-modal " id="signInModal" tabindex="-1" aria-labelledby="signInModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="mt-3 mb-2">Connect With Your Metamask Wallet.
                <button class="form-control" style="background:transparent" style="margin-right:5px" onclick="connect_wallet();"><img width="30px"  src="{{cdnAsset('assets/user/img/home-page/hero-area/', 'metamask.svg')}}" alt="sign">Sign in with Metamask</button>
