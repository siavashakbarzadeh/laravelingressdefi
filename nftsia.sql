...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 16, 2022 at 11:43 AM
...
INSERT INTO `users` (`id`, `first_name`, `last_name`, `bio`, `email`, `reset_code`, `role`, `status`, `country_code`, `phone`, `phone_verified`, `country`, `gender`, `birth_date`, `photo`, `cover_photo`, `website`, `g2f_enabled`, `google2fa_secret`, `is_verified`, `password`, `language`, `device_id`, `device_type`, `push_notification_status`, `email_notification_status`, `new_bid_notification`, `item_purchased_notification`, `people_follow_notification`, `remember_token`, `created_at`, `updated_at`) VALUES
(1, 'Mr.', 'Admin', NULL, 'admin@email.com', NULL, 1, 1, NULL, NULL, 0, NULL, 1, NULL, NULL, NULL, NULL, '0', NULL, 1, '$2y$10$AfUJQHOw6RUmOZ3E5ZNkj.nyaDB/VWSxwl87.7iLz42/uOPC.7DKG', 'en', NULL, 1, 1, 1, 1, 1, 1, NULL, NULL, NULL),
(2, 'John', 'Doe', 'Wonderful serenity has taken possession of my entire soul, these mornings', 'user1@email.com', NULL, 2, 1, NULL, NULL, 0, 'Australia', 1, NULL, '1.jpg', NULL, NULL, '0', NULL, 1, '$2y$10$6C7HLYrPoTACH1x6YMg7BeVv4B9NJA.kWk5/Swop8uTRivMWu5PZ2', 'en', NULL, 1, 1, 1, 1, 1, 1, NULL, NULL, NULL),
(3, 'Hnik', 'Zairiya', 'Wonderful serenity has taken possession of my entire soul, these mornings', 'user2@email.com', NULL, 2, 1, NULL, NULL, 0, 'Australia', 1, NULL, '2.jpg', NULL, 'https://example.com', '0', NULL, 1, '$2y$10$VCC2eUKdqppvlgLeJGpv2O9BWe.Gq3Wx.BsSbT7aYO/g1bmjYLUsC', 'en', NULL, 1, 1, 1, 1, 1, 1, NULL, NULL, NULL),
(4, 'Robert', 'Gomez', 'Wonderful serenity has taken possession of my entire soul, these mornings', 'user3@email.com', NULL, 2, 1, NULL, NULL, 0, 'Australia', 1, NULL, '3.jpg', NULL, 'https://example.com', '0', NULL, 1, '$2y$10$HMuNdS58ypLQ7g2eVRca2usTsJXJCGhvtS/5ZmYZvruxcz7Bu9svC', 'en', NULL, 1, 1, 1, 1, 1, 1, NULL, NULL, NULL),
(5, 'MacKensie', 'Duke', 'Wonderful serenity has taken possession of my entire soul, these mornings', 'user4@email.com', NULL, 2, 1, NULL, NULL, 0, 'Australia', 1, NULL, '4.jpg', NULL, 'https://example.com', '0', NULL, 1, '$2y$10$V2VXsbmqo8I7WWtXKfRKC.3RaRVZCdvIMzhKyTcUHx3qiTN8BvErG', 'en', NULL, 1, 1, 1, 1, 1, 1, NULL, NULL, NULL),
(6, 'Petra', 'Garza', 'Wonderful serenity has taken possession of my entire soul, these mornings', 'user5@email.com', NULL, 2, 1, NULL, NULL, 0, 'Australia', 1, NULL, '5.jpg', NULL, 'https://example.com', '0', NULL, 1, '$2y$10$dj21KIw9sjzU4RnnHN1AmezP8B9ybJoCshw.RjM2cJ/gi1lZeIZ56', 'en', NULL, 1, 1, 1, 1, 1, 1, NULL, NULL, NULL);
